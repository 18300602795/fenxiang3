...
public class MineGiftRecordActivity extends ImmerseActivity {
    ...
    private String[] titleNames={"我的礼包", "我的商品"};
    ...
    public static void start(Context context) {
        Intent starter = new Intent(context, MineGiftRecordActivity.class);
