...
import static com.etsdk.app.huov7.base.AileApplication.initListener;
    ...
    public int onStartCommand(final Intent intent, int flags, int startId) {
        ...
        huosdkManager.initSdk(this, new OnInitSdkListener() {
            ...
            public void initSuccess(String code, String msg) {
                L.e(TAG, "初始化成功了" + AileApplication.initListener);
                if (AileApplication.initListener != null) {
                    AileApplication.initListener.initSuccess();
                }
            }
            ...
            public void initError(String code, String msg) {
                ...
                if (AileApplication.initListener != null) {
                    AileApplication.initListener.initError(code, msg);
                }
            }
        });
